...
<head><meta equiv="Content-Type" content="text/html; charset=TIS-620">
	...
	function gopage(pages) {
		document.form1.action="orders_account.jsp?pages="+pages;
		document.form1.submit();
	}
	function detail(orders_no,year){
		window.location="../sell/orders_detail.jsp?orders_no="+orders_no+"&year="+year;
	}
	function paymoney(orders_no,year){
		window.location="orders_pay.jsp?orders_no="+orders_no+"&year="+year;
	}
	</script>
</head>
<body> 
<font  class="f1">บัญชีใบขายสินค้า</font>
<form action="orders_account.jsp" name="form1" method="post">
...
<table width="100%" cellpadding="3" cellspacing="2" >
	<tr class="tr0" >
		...
		<td align="center" width="30%">ชื่อลูกค้า</td>
...
<%
					if(pays.equals("N")){
%>
					<td align="center"><a href="javascript:paymoney(<%=orders_no%>,<%=year%>)">จ่ายเงิน</a></td>
<%
					}else{
%>
